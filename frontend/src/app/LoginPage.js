    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded shadow p-8 w-full max-w-md">
        <div className="flex flex-col items-center mb-6">
          <img src="/placeholder.svg?height=80&width=80" alt="Logo" className="h-20 w-20 mb-2" />
          <h1 className="text-2xl font-bold text-center mb-1">Sistema de Gestión de Cosecha</h1>
